...
const Market = () => {
  ...
  useEffect(() => {
    const fetchProducers = async () => {
      setLoading(true);
      try {
        // Fetch profiles and their associated produce
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <main className="container mx-auto px-4 -mt-8 pb-20">
        <div className="bg-white p-4 rounded-3xl shadow-xl border border-slate-100 mb-12 flex flex-col md:flex-row gap-4">
          ...
          <div className="flex gap-2">
            <button className="flex items-center gap-2 px-6 h-12 rounded-2xl bg-slate-50 text-slate-600 font-medium hover:bg-slate-100 transition-colors">
